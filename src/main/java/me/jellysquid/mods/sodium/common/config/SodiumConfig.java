...
public class SodiumConfig {
    private static final Logger LOGGER = LogManager.getLogger(Vitrine.MODNAME + "Config");

    private static final String JSON_KEY_SODIUM_OPTIONS = "vitrine:options";
    ...
    private static void writeDefaultConfig(File file) throws IOException {
        ...
        try (Writer writer = new FileWriter(file)) {
            writer.write("# This is the configuration file for " + Vitrine.MODNAME + ".\n");
            writer.write("#\n");
